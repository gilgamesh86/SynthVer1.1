...
#define SH1106_WRITECOMMAND(command)                                           \
  SH1106_I2C_Write(SH1106_I2C_ADDR, 0x00, (command))
/* Write data */
...
uint8_t SH1106_Init(void) {
  ...
  SH1106_WRITECOMMAND(
      0xB0 | 0x00); // Set Page Start Address for Page Addressing Mode,0-7
...
void SH1106_UpdateScreen(void) {
  ...
  for (m = 0; m < 8; m++) {
    ...
    /* Write multi data */
    SH1106_I2C_WriteMulti(SH1106_I2C_ADDR, 0x40,
                          &SH1106_Buffer[SH1106_WIDTH * m], SH1106_WIDTH);
  }
}
...
void SH1106_DrawLine(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1,
                     SH1106_COLOR_t c) {
...
void SH1106_DrawRectangle(uint16_t x, uint16_t y, uint16_t w, uint16_t h,
                          SH1106_COLOR_t c) {
...
void SH1106_DrawFilledRectangle(uint16_t x, uint16_t y, uint16_t w, uint16_t h,
                                SH1106_COLOR_t c) {
  uint8_t i;
...
void SH1106_DrawFilledTriangle(uint16_t x1, uint16_t y1, uint16_t x2,
...
void SH1106_DrawFilledCircle(int16_t x0, int16_t y0, int16_t r,
                             SH1106_COLOR_t c) {
  int16_t f = 1 - r;
  int16_t ddF_x = 1;
  int16_t ddF_y = -2 * r;
...
void SH1106_I2C_WriteMulti(uint8_t address, uint8_t reg, uint8_t *data,
                           uint16_t count) {
  uint8_t dt[256];
  dt[0] = reg;
  uint8_t i;
